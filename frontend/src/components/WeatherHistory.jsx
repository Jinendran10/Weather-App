  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="card p-6 w-full max-w-md space-y-4">
        <h3 className="text-lg font-bold text-text-main">Edit Query</h3>
        <div>
  ...
  if (!queries || queries.length === 0) {
    return (
      <div className="text-center py-12 text-slate-500">
        ...
        <p className="text-lg text-text-sec">No weather queries yet.</p>
        <p className="text-sm mt-1 text-slate-400">Use the form above to save your first query.</p>
      </div>
    )
  }
          ...
          <div key={q.id} className="card overflow-hidden">
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1 text-sm text-text-sec flex-wrap">
                  ...
                  <span className="text-slate-400 text-xs">{q.record_count} records</span>
                </div>
              </div>
