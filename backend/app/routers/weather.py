...
Endpoints:
  POST   /weather/current          – Get live current weather (not persisted)
...
from app.models.weather import Location, WeatherQuery, WeatherRecord, QueryStatus
...
from app.services.weather_service import weather_service, WeatherAPIError
...
async def _resolve_or_create_location(
    ...
    """Geocode a location string and persist it (or re-use an existing one)."""
    try:
...
async def get_current_weather(
    ...
    The result is **not** persisted to the database.
    """
